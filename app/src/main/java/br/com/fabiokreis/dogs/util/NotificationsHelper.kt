package br.com.fabiokreis.dogs.util
...
import br.com.fabiokreis.dogs.view.MainActivity
...
class NotificationsHelper(val context: Context) {
    ...
    fun createNotification() {
        ...
        val icon = BitmapFactory.decodeResource(context.resources, R.drawable.original)
